    ...
    <div style="width: 100%; background-color: #f9fafb; padding: 40px 0;">
        ...
        <div style="max-width: 540px; margin: 0 auto; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05); border: 1px solid #e5e7eb;">
            ...
            <div style="padding: 20px 48px 48px 48px; text-align: center;">
                ...
                <a href="{{ $url }}" style="display: inline-block; background-color: #111827; color: #ffffff; padding: 16px 40px; border-radius: 9999px; text-decoration: none; font-weight: 600; font-size: 16px; margin-bottom: 32px; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
                    Reset password
                </a>
            ...
            <div style="padding: 32px 48px; text-align: center;">
                ...
                <a href="{{ $url }}" style="word-break: break-all; color: #16a34a; font-size: 12px; text-decoration: none; font-weight: 500;">
                    {{ $url }}
                </a>
            </div>
        </div>
