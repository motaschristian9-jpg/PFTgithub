          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-3 flex-1 min-w-0">
                <div className="w-10 h-10 bg-gradient-to-r from-green-600 to-green-700 rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                  <span className="text-white font-bold text-lg">M</span>
                </div>
                <span
                  className={`text-xl font-bold bg-gradient-to-r from-green-600 to-green-700 bg-clip-text text-transparent transition-opacity duration-200 ${
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-all duration-200 text-gray-600 cursor-pointer flex-shrink-0 ${
                  sidebarOpen ? "ml-4" : "ml-6"
                }`}
              >
                <ChevronLeft
                  size={18}
