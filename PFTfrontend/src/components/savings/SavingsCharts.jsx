      ...
      <div className="bg-white p-3 rounded-xl shadow-xl border border-gray-100 text-xs">
        ...
        <div className="space-y-0.5">
          <p className="text-gray-500">
            Saved: <span className="font-bold text-teal-600">{formatCurrency(data.current, userCurrency)}</span>
          </p>
          <p className="text-gray-500">
            Target: <span className="font-bold text-gray-700">{formatCurrency(data.target, userCurrency)}</span>
          </p>
...
const SavingsCharts = ({ savings, userCurrency }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 relative overflow-hidden">
      ...
      <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-center items-center text-center">
