  ...
  return (
    <div className="rounded-2xl bg-white shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
      <div className="p-6 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
        <h3 className="text-lg font-bold text-gray-900">Budget History</h3>
        ...
        <div className="p-4 border-t border-gray-100 flex justify-center bg-gray-50/30">
          <div className="flex space-x-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 disabled:opacity-50 text-sm font-medium shadow-sm"
            >
              Previous
            </button>
            <span className="px-3 py-1.5 text-gray-600 text-sm font-medium flex items-center">
