                ...
                >
                  ...
                  <td
                    className={`py-4 px-6 font-medium ${
                      b.remaining < 0 ? "text-rose-600 dark:text-rose-400" : "text-violet-600 dark:text-violet-400"
                    }`}
                  >
      ...
      <div className="lg:hidden">
        {budgetCompliance.length === 0 ? (
           ...
           <div className="divide-y divide-gray-100 dark:divide-gray-800">
              {budgetCompliance.map((b) => (
                <div key={b.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                     <div className="min-w-0 flex-1 pr-2">
                       <h4 className="text-sm font-bold text-gray-900 dark:text-white truncate">{b.name}</h4>
                       <span className="inline-flex items-center mt-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300">
                          {b.category}
                       </span>
                     </div>
