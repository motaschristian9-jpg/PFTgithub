...
const StatCard = ({ title, value, icon: Icon, colorClass, bgClass, iconColorClass }) => {
  ...
  const getColorTheme = () => {
    if (colorClass.includes("emerald")) return { bg: "bg-emerald-50", text: "text-emerald-600", icon: "text-emerald-200" };
    if (colorClass.includes("rose")) return { bg: "bg-rose-50", text: "text-rose-600", icon: "text-rose-200" };
